    ...
    return (
        ...
        >
            {props.fieldPlaceholder && (
                <span className="text-2xl">{props.fieldPlaceholder}</span>
            )}
            <>
                <input
                    type="checkbox"
                    className={
                        `min-w-0 accent-sky-400 transition-colors` +
                ...
                <AnimatePresence mode="wait">
                    {edit && error && (
                        <motion.p
                            ...
                            className="text-l text-center mt-2 border-white border bg-red-400 py-1 px-2 rounded-md"
                        >
                            {errorMessage}
                        </motion.p>
                    )}
